...
<body>
    <div>
        <h3>Lista de Reprobados <span class="derecha">{{now()}}</span></h3>
    </div>
    <div>
  ...
  <div>
        <h3>Lista de Aprobados <span class="derecha">{{now()}}</span></h3>
    </div>
  <div>
        <table class="table table-bordered table-striped table-sm">
            <thead>
  ...
  <div>
        <h3>En espera <span class="derecha">{{now()}}</span></h3>
    </div>
  <div>
        <table class="table table-bordered table-striped table-sm">
            <thead>
